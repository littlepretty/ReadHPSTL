...
class hashtable 
{
  ...
  vector<_Node*,_Alloc> _M_buckets; /// every element in this vector is the head of a node list
...
public:
  ...
  /// size of next bucket is picked from prime number array
  size_type _M_next_size(size_type __n) const 
  {
    return __stl_next_prime(__n); 
  }

  /// essencial step in constructor
